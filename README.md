...
<img src="assets/design-systems-logo.svg" alt="Design Systems logo" width="80"/>
...
| `AI Image Generation Dashboard` | Dashboard | Prompt-to-image tool UI |
| `AI Knowledge Base Mockup` | Dashboard | Searchable knowledge base UI |
| `AI Resume Builder UI` | Tool | Guided resume builder mockup |
| `SaaS Landing Page Design` | Landing Page | Conversion-focused SaaS marketing page |
...
Released under the [MIT License](LICENSE) — © 2026 Poorvith M P. Individual templates may bundle third-party assets under their own licenses (see each project's `ATTRIBUTIONS.md`).

---

> Built with [Figma Make](https://www.figma.com/make) → React · by [Poorvith M P](https://github.com/prvthmpcypher)
